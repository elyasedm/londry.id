...
public class Cuci extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jasacuci);

        mWebView = (WebView)findViewById(R.id.tablighweb);

        mWebView.setWebViewClient(new Cuci.myWebclient());
        webSettings = mWebView.getSettings();

        mWebView.setWebViewClient(new WebViewClient());
        mWebView.loadUrl("http://londry.id/CuciAja.html");
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentHome = new Intent(Cuci.this, MainActivity.class);
                Cuci.this.startActivity(intentHome);
                Cuci.this.finish();
            }
        });
        ...
        btnJasa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentJasa = new Intent(Cuci.this, JasaActivity.class);
                Cuci.this.startActivity(intentJasa);
                Cuci.this.finish();
            }
        });
        ...
        btnKami.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentKami = new Intent(Cuci.this, Kami.class);
                Cuci.this.startActivity(intentKami);
                Cuci.this.finish();
            }
        });
