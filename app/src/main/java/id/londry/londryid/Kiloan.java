...
public class Kiloan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jasakiloan);

        mWebView = (WebView)findViewById(R.id.tablighweb);

        mWebView.setWebViewClient(new Kiloan.myWebclient());
        webSettings = mWebView.getSettings();

        mWebView.setWebViewClient(new WebViewClient());
        mWebView.loadUrl("http://londry.id/CnG.html");
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentHome = new Intent(Kiloan.this, MainActivity.class);
                Kiloan.this.startActivity(intentHome);
                Kiloan.this.finish();
            }
        });
        ...
        btnJasa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentJasa = new Intent(Kiloan.this, JasaActivity.class);
                Kiloan.this.startActivity(intentJasa);
                Kiloan.this.finish();
            }
        });
        ...
        btnKami.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentKami = new Intent(Kiloan.this, Kami.class);
                Kiloan.this.startActivity(intentKami);
                Kiloan.this.finish();
            }
        });
